...
const selectCaptionFileForTTS = async (track, selectedLanguageCode = null) => {
  ...
  if (xml) {
    ...
    //necessery, as Youtube sometimes has those empty UML tags, which was triggering an assert statement with remote GoogleVoices, due to an empty string. Example below:
